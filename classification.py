...
def initialize_model(num_classes , feature_extract = False):
    ...
    model.fc = nn.Linear(num_ftrs, num_classes) # only this layer will be trained with our data.
    return model
    ...
    for i, image in enumerate(data['images']):
        ...
        for annotation in data['annotations']:
            if annotation['image_id'] == image_id:
                ...
                crop1 = crop1.resize((model_input_size, model_input_size), Image.BILINEAR)
...
if __name__ == '__main__':
    ...
    data_transforms = {
        'train': transforms.Compose([
            ...
            transforms.RandomResizedCrop(model_input_size, scale=(0.9, 1.1), ratio=(0.9, 1.1)), 
    ...
    dataloaders_dict = {
        'train': torch.utils.data.DataLoader(image_datasets['train'], batch_size=batch_size, shuffle=True, num_workers=2), # TODO: change in gpu
